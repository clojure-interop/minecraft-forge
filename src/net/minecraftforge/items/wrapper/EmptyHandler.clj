(ns net.minecraftforge.items.wrapper.EmptyHandler
...
(defn get-stack-in-slot
  ...
  (^net.minecraft.item.ItemStack [^EmptyHandler this ^Integer slot]
...
(defn insert-item
  ...
  (^net.minecraft.item.ItemStack [^EmptyHandler this ^Integer slot ^net.minecraft.item.ItemStack stack ^Boolean simulate]
...
(defn extract-item
  ...
  (^net.minecraft.item.ItemStack [^EmptyHandler this ^Integer slot ^Integer amount ^Boolean simulate]
...
(defn set-stack-in-slot
  ...
  ([^EmptyHandler this ^Integer slot ^net.minecraft.item.ItemStack stack]
...
(defn get-slot-limit
  ...
  (^Integer [^EmptyHandler this ^Integer slot]
