(ns net.minecraftforge.items.wrapper.RangedWrapper
...
(defn ->ranged-wrapper
  ...
  compose - `net.minecraftforge.items.IItemHandlerModifiable`
  min-slot - `int`
  max-slot-exclusive - `int`"
  (^RangedWrapper [^net.minecraftforge.items.IItemHandlerModifiable compose ^Integer min-slot ^Integer max-slot-exclusive]
    (new RangedWrapper compose min-slot max-slot-exclusive)))

(defn get-slots
  "Description copied from interface: IItemHandler

  returns: The number of slots available - `int`"
  (^Integer [^RangedWrapper this]
    (-> this (.getSlots))))
...
(defn get-stack-in-slot
  ...
  (^net.minecraft.item.ItemStack [^RangedWrapper this ^Integer slot]
...
(defn insert-item
  ...
  (^net.minecraft.item.ItemStack [^RangedWrapper this ^Integer slot ^net.minecraft.item.ItemStack stack ^Boolean simulate]
...
(defn extract-item
  ...
  (^net.minecraft.item.ItemStack [^RangedWrapper this ^Integer slot ^Integer amount ^Boolean simulate]
...
(defn set-stack-in-slot
  ...
  ([^RangedWrapper this ^Integer slot ^net.minecraft.item.ItemStack stack]
...
(defn get-slot-limit
  ...
  (^Integer [^RangedWrapper this ^Integer slot]
