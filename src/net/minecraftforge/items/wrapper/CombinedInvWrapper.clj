(ns net.minecraftforge.items.wrapper.CombinedInvWrapper
  (:refer-clojure :only [require comment defn ->])
  (:import [net.minecraftforge.items.wrapper CombinedInvWrapper]))

(defn ->combined-inv-wrapper
  "Constructor.

  item-handler - `net.minecraftforge.items.IItemHandlerModifiable`"
  (^CombinedInvWrapper [^net.minecraftforge.items.IItemHandlerModifiable item-handler]
    (new CombinedInvWrapper item-handler)))
...
(defn set-stack-in-slot
  ...
  ([^CombinedInvWrapper this ^Integer slot ^net.minecraft.item.ItemStack stack]
...
(defn get-slots
  ...
  (^Integer [^CombinedInvWrapper this]
    (-> this (.getSlots))))
...
(defn get-stack-in-slot
  ...
  (^net.minecraft.item.ItemStack [^CombinedInvWrapper this ^Integer slot]
...
(defn insert-item
  ...
  (^net.minecraft.item.ItemStack [^CombinedInvWrapper this ^Integer slot ^net.minecraft.item.ItemStack stack ^Boolean simulate]
...
(defn extract-item
  ...
  (^net.minecraft.item.ItemStack [^CombinedInvWrapper this ^Integer slot ^Integer amount ^Boolean simulate]
...
(defn get-slot-limit
  ...
  (^Integer [^CombinedInvWrapper this ^Integer slot]
