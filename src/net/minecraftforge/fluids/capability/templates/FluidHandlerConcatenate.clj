(ns net.minecraftforge.fluids.capability.templates.FluidHandlerConcatenate
...
(defn ->fluid-handler-concatenate
  "Constructor.

  sub-handlers - `net.minecraftforge.fluids.capability.IFluidHandler`"
  (^FluidHandlerConcatenate [^net.minecraftforge.fluids.capability.IFluidHandler sub-handlers]
    (new FluidHandlerConcatenate sub-handlers)))
...
(defn fill
  ...
  (^Integer [^FluidHandlerConcatenate this ^net.minecraftforge.fluids.FluidStack resource ^Boolean do-fill]
...
(defn drain
  ...
  (^net.minecraftforge.fluids.FluidStack [^FluidHandlerConcatenate this ^net.minecraftforge.fluids.FluidStack resource ^Boolean do-drain]
