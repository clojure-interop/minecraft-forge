(ns net.minecraft.util.text.Style$Serializer
...
(defn deserialize
  ...
  (^net.minecraft.util.text.Style [^Style$Serializer this ^com.google.gson.JsonElement p-deserialize-1 ^java.lang.reflect.Type p-deserialize-2 ^com.google.gson.JsonDeserializationContext p-deserialize-3]
    (-> this (.deserialize p-deserialize-1 p-deserialize-2 p-deserialize-3))))

(defn serialize
  "p-serialize-1 - `net.minecraft.util.text.Style`
  ...
  (^com.google.gson.JsonElement [^Style$Serializer this ^net.minecraft.util.text.Style p-serialize-1 ^java.lang.reflect.Type p-serialize-2 ^com.google.gson.JsonSerializationContext p-serialize-3]
